...
<h2>Manage Users</h2>
<a id="add" href="/add/user"><button>Add User</button></a>
	<table>
		<thead>
			<tr>
				<th>ID</th>
		...
		<tbody>
			<?
				foreach ($data as $item) {
					...
					echo "<td><a href='/edit/user/{$item['id']}'><button type='button'>Edit</button></a></td>";
					echo "<td><a href='/main/destroy/{$item['id']}'><button type='button'>Delete</button></a></td>";
				}
			?>
		</tbody>
	</table>
